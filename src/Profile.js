...
function Profile(){
    return(
        <div className="container">
           ...
           <img className="img-fluid mt-3 mb-0 profile-cover" src="https://i.pinimg.com/originals/30/5c/5a/305c5a457807ba421ed67495c93198d3.jpg" alt="profile cover photo"></img>
                <div className="d-flex justify-content-center flex-column">
                <img
                    class="img-fluid rounded-circle user-pic"
                    src="https://img.icons8.com/fluency/344/test-account.png"
                  ></img>
