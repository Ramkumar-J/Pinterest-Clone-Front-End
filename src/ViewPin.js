        ...
        <div className="container p-0 view-pin">
            <div className="row mt-3 mb-5">
                <div className="col-lg-6">
                    <img class="img-fluid w-100 bg-secondary viewpin-image" src={view.image}></img>
                </div>
                <div className="col-lg-6 p-5">
                    ...
                    <a href={view.image} download><img class="ms-2 rounded-circle p-1" src="https://img.icons8.com/pastel-glyph/40/download.png" alt=""/></a>
                        ...
                        <div className="col-6 col-sm-6 col-md-6 col-lg-6">
                        <button class="btn btn-danger rounded-pill" onClick={() => props.Addsavedpin(view)}>Save</button>
                        </div>
                    </div>
                    <div className="row mt-3">
